...
export default function Consultas() {
    ...
    // Estado para controlar o sumiço imediato do RefreshControl
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <View style={styles.content}>
                        ...
                        {/* Mantendo o loading exatamente como estava */}
                ...
                ListEmptyComponent={
                    (!loading && !error) ? <Text style={styles.emptyText}>Nenhuma consulta agendada</Text> : null
                }
            />
